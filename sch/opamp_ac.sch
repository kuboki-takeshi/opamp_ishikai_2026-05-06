...
save all
ac dec 20 1e3 1e10
gnuplot opamp_freq vdb(out)
gnuplot opamp_phase vp(out)
plot vdb(out)
plot vp(out)
.endc"}
...
C {devices/code_shown.sym} -470 -20 0 0 {name=measure only_toplevel=false value=".measure ac gain find vdb(out) at=1e3
.measure ac ugf when vdb(out)=0
.measure ac phase find vp(out) at=2.23487e6"}
...
C {devices/isource.sym} 140 -180 0 0 {name=I0 value=11.8u}
